...
class Pipe{
    ...
    draw(){
        ...
        this.gradient = this.fx.createTwoColorGradient(
            this.xpos, 0, this.xpos+40, 0, this.color1, this.color2
        )
        this.fx.fillRectangle(this.xpos, 0, this.width, this.top, this.gradient);
        this.fx.fillRectangle(this.xpos, this.fx.dimensions().height - this.bottom, this.width, this.bottom, this.gradient);
    }
